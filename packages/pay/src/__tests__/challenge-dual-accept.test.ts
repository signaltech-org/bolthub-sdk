...
function wallet(preimage = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"): WalletAdapter {
...
describe("challenge dual-accept (token= / macaroon=)", () => {
  test("token= credential is parsed, paid, and echoed in Authorization", async () => {
    const client = new L402Client({ wallet: wallet("beefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeef") });
    ...
    expect(authHeaders[1]).toBe("L402 tok456:beefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeef");
  });
  ...
  test("macaroon= still works and wins when both are present", async () => {
    ...
    expect(authHeaders[1]).toBe("L402 mac:beefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeefbeef");
  });
