 ...
 * listed API. Six tools, exposed UNPREFIXED even in prefix mode — they are
 * the server's native surface and their descriptions cross-reference each
 * other by bare name. (Per-endpoint tools for the whole directory would
